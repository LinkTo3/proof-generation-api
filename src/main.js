...
const swaggerOptions = {
  swaggerDefinition: {
    info: {
      ...
      description: `The Proof Generation API primarily helps the TOK SDK by executing a few heavy processes
       on a dedicated backend server. Proof generation and block inclusion check are some of the endpoints
       on this proof generation API. The logic behind these API's involves making several RPC calls to the LinkTo
